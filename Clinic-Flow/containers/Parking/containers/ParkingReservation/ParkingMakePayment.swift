...
struct ParkingMakePayment: View {
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 25) {
                ...
                NavigationLink(destination: ParkingPaymentConfirmation()) {
                    Text("Make Payment").font(.headline).foregroundColor(.white).frame(maxWidth: .infinity).padding(.vertical, 18).background(Color.orange).cornerRadius(30)
                }
            }
            .padding(25)
        }
